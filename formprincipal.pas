  ...
  if Application.MessageBox(pchar('Desea eliminar el registro del cliente: '+cliente),pchar('CRUD [PRUEBA DE INGRESO]'),mb_iconinformation+MB_YESNO + MB_DEFBUTTON1)= mryes then
   begin
     ...
     begin
      ...
      Application.MessageBox(pchar('Se modifico el el número telefonico para el cliente: '+cliente),pchar('CRUD [PRUEBA DE INGRESO]'),mb_iconinformation);
  abrirtabla;
end;
...
begin
 ...
 codcliente:=dbgrid1.Fields[0].AsString;
 cliente:=dbgrid1.Fields[1].AsString;
  if Application.MessageBox(pchar('Desea modificar el número telefonico para el cliente: '+cliente),pchar('CRUD [PRUEBA DE INGRESO]'),mb_iconinformation+MB_YESNO + MB_DEFBUTTON1)= mryes then
   begin
...
begin
 ...
 codcliente:=dbgrid1.Fields[0].AsString;
 cliente:=dbgrid1.Fields[1].AsString;
  if Application.MessageBox(pchar('Desea modificar el número de documento para el cliente: '+cliente),pchar('CRUD [PRUEBA DE INGRESO]'),mb_iconinformation+MB_YESNO + MB_DEFBUTTON1)= mryes then
   begin
        valor := InputBox('Ingrese núumero de documento', 'ndcu : ', '');
     ...
     begin
      ...
      Application.MessageBox(pchar('Se modifico el número de documento para el cliente: '+cliente),pchar('CRUD [PRUEBA DE INGRESO]'),mb_iconinformation);
...
begin
   ...
   begin
     ...
     abrirtabla;
      ...
      begin
        application.MessageBox(pwidechar('Faltan datos de cliente.'+#13+#13+'Verifique "Nombre, Identificación, Telefono y Correo electronico"'),'CRUD',mb_ok+MB_ICONINFORMATION);
     end;
end;
end.
